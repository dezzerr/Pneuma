...
_BOOKS: list[tuple[int, str, list[str]]] = [
    ...
    (
        5,
        "Deuteronomy",
        ["deuteronomy", "deut", "duet", "deutronomy", "do you turn on me", "g tronon"],
    ),
    ...
    (
        10,
        "2 Samuel",
        ["second samuel", "2nd samuel", "2 samuel", "second sam", "2 sam", "ii samuel"],
    ),
    ...
    (
        38,
        "Zechariah",
        ["zechariah", "zech", "zacharia", "zachary", "the career", "the korea", "the carrillo"],
    ),
    ...
    (
        54,
        "1 Timothy",
        ["first timothy", "1st timothy", "1 timothy", "first tim", "1 tim", "i timothy"],
    ),
    (
        55,
        "2 Timothy",
        ["second timothy", "2nd timothy", "2 timothy", "second tim", "2 tim", "ii timothy"],
    ),
    (56, "Titus", ["titus"]),
...
def words_to_number(token: str) -> int | None:
